...
namespace StoreFrontV3.UI.MVC.Controllers
{
    public class ShippersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShippingID,CompanyName")] Shipper shipper)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShippingID,CompanyName")] Shipper shipper)
        {
            if (ModelState.IsValid)
            {
